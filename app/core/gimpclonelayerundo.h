...
struct GimpCloneLayerUndo
{
  GimpItemUndo       parent_instance;
};

struct GimpCloneLayerUndoClass
{
...
__DECLARE_GTK_CLASS__(GimpCloneLayerUndo, GIMP_TYPE_CLONE_LAYER_UNDO);
#endif

#endif /* __GIMP_CLONE_LAYER_UNDO_H__ */
