...
gimp_undo_type_get_type (void)
{
  static const GEnumValue values[] =
  {
    ...
    { GIMP_UNDO_GROUP_LAYER_APPLY_PRESET, "GIMP_UNDO_GROUP_LAYER_APPLY_PRESET", "group-layer-apply-preset" },
  ...
  static const GimpEnumDesc descs[] =
  {
    ...
    { GIMP_UNDO_GROUP_LAYER_APPLY_PRESET, NC_("undo-type", "Apply layer preset"), NULL },
