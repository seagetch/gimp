...
#define BRUSH_BRUSHMARK_SPECIFIED (BRUSH_BOOL_BASE + 3)
#define BRUSH_TEXTURE_SPECIFIED   (BRUSH_BOOL_BASE + 4)
#define BRUSH_BOOL_END            (BRUSH_BOOL_BASE + 5)
...
#define BRUSH_TEXTURE_NAME        (BRUSH_TEXT_BASE + 1)
#define BRUSH_TEXT_END            (BRUSH_TEXT_BASE + 2)
