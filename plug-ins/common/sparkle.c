...
query (void)
{
  static const GimpParamDef args[] =
  {
    ...
    { GIMP_PDB_INT32,    "spike-len",     "Spike length (in pixels) (1 - 100)" },
    { GIMP_PDB_INT32,    "spike-pts",     "# of spike points (0 - 16)" },
    { GIMP_PDB_INT32,    "spike-angle",   "Spike angle (-1 - 360) (degrees, -1: random)" },
