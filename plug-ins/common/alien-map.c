...
query (void)
{
  static const GimpParamDef args[] =
  {
    ...
    { GIMP_PDB_FLOAT,    "redfrequency",   "<Red/hue> frequency factor (0-20)" },
    { GIMP_PDB_FLOAT,    "redangle",       "<Red/hue> angle factor (0-360)" },
    { GIMP_PDB_FLOAT,    "greenfrequency", "<Green/saturation> frequency factor (0-20)" },
    { GIMP_PDB_FLOAT,    "greenangle",     "<Green/saturation> angle factor (0-360)" },
    { GIMP_PDB_FLOAT,    "bluefrequency",  "<Blue/luminance> frequency factor (0-20)" },
    { GIMP_PDB_FLOAT,    "blueangle",      "<Blue/luminance> angle factor (0-360)" },
