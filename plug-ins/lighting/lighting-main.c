...
query (void)
{
  static const GimpParamDef args[] =
  {
    ...
    { GIMP_PDB_INT32,    "bumpmaptype",           "Type of mapping { linear (0), log (1), sinusoidal (2), spherical(3) }" },
    { GIMP_PDB_INT32,    "lighttype",             "Type of lightsource { point (0), directional (1), spot(3), none(4) }" },
    { GIMP_PDB_COLOR,    "lightcolor",            "Lightsource color (r,g,b)" },
    { GIMP_PDB_FLOAT,    "lightposition-x",       "<Lightsource position>X-position (x,y,z)" },
    { GIMP_PDB_FLOAT,    "lightposition-y",       "<Lightsource position>Y-position (x,y,z)" },
    { GIMP_PDB_FLOAT,    "lightposition-z",       "<Lightsource position>Z-position (x,y,z)" },
    { GIMP_PDB_FLOAT,    "lightdirection-x",      "<Lightsource direction>X-position [x,y,z]" },
    { GIMP_PDB_FLOAT,    "lightdirection-y",      "<Lightsource direction>Y-position [x,y,z]" },
    { GIMP_PDB_FLOAT,    "lightdirection-z",      "<Lightsource direction>Z-position [x,y,z]" },
