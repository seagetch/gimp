...
query (void)
{
  static const GimpParamDef args[] =
  {
    ...
    { GIMP_PDB_INT32,    "maptype",               "Type of mapping {plane (0), sphere (1), box (2), cylinder (3) }" },
    { GIMP_PDB_FLOAT,    "viewpoint-x",           "<Viewpoint>X-position (x,y,z)" },
    { GIMP_PDB_FLOAT,    "viewpoint-y",           "<Viewpoint>Y-position (x,y,z)" },
    { GIMP_PDB_FLOAT,    "viewpoint-z",           "<Viewpoint>Z-position (x,y,z)" },
    { GIMP_PDB_FLOAT,    "position-x",            "<Object> X-position (x,y,z)" },
    { GIMP_PDB_FLOAT,    "position-y",            "<Object> Y-position (x,y,z)" },
    { GIMP_PDB_FLOAT,    "position-z",            "<Object> Z-position (x,y,z)" },
    { GIMP_PDB_FLOAT,    "firstaxis-x",           "<First axis of object> X [x,y,z]" },
    { GIMP_PDB_FLOAT,    "firstaxis-y",           "<First axis of object> Y [x,y,z]" },
    { GIMP_PDB_FLOAT,    "firstaxis-z",           "<First axis of object> Z [x,y,z]" },
    { GIMP_PDB_FLOAT,    "secondaxis-x",          "<Second axis of object> X [x,y,z]" },
    { GIMP_PDB_FLOAT,    "secondaxis-y",          "<Second axis of object> Y [x,y,z]" },
    { GIMP_PDB_FLOAT,    "secondaxis-z",          "<Second axis of object> Z [x,y,z]" },
    { GIMP_PDB_FLOAT,    "rotationangle-x",       "<Rotation> X axis (in degrees)" },
    { GIMP_PDB_FLOAT,    "rotationangle-y",       "<Rotation> Y axis (in degrees)" },
    { GIMP_PDB_FLOAT,    "rotationangle-z",       "<Rotation> Z axis (in degrees)" },
    { GIMP_PDB_INT32,    "lighttype",             "Type of lightsource { point (0), directional (1), none(2) }" },
    { GIMP_PDB_COLOR,    "lightcolor",            "<Lightsource> color (r,g,b)" },
    { GIMP_PDB_FLOAT,    "lightposition-x",       "<Lightsource position> X (x,y,z)" },
    { GIMP_PDB_FLOAT,    "lightposition-y",       "<Lightsource position> Y (x,y,z)" },
    { GIMP_PDB_FLOAT,    "lightposition-z",       "<Lightsource position> Z (x,y,z)" },
    { GIMP_PDB_FLOAT,    "lightdirection-x",      "<Lightsource direction> X [x,y,z]" },
    { GIMP_PDB_FLOAT,    "lightdirection-y",      "<Lightsource direction> Y [x,y,z]" },
    { GIMP_PDB_FLOAT,    "lightdirection-z",      "<Lightsource direction> Z [x,y,z]" },
    ...
    { GIMP_PDB_FLOAT,    "x-scale",               "<Box size> X (0..->)" },
    { GIMP_PDB_FLOAT,    "y-scale",               "<Box size> Y (0..->)" },
    { GIMP_PDB_FLOAT,    "z-scale",               "<Box size> Z (0..->)"},
    { GIMP_PDB_FLOAT,    "cylinder-length",       "Cylinder length (0..->)"},
    { GIMP_PDB_DRAWABLE, "box-front-drawable",    "<Box face> front (set these to -1 if not used)" },
    { GIMP_PDB_DRAWABLE, "box-back-drawable",     "<Box face> back" },
    { GIMP_PDB_DRAWABLE, "box-top-drawable",      "<Box face> top" },
    { GIMP_PDB_DRAWABLE, "box-bottom-drawable",   "<Box face> bottom" },
    { GIMP_PDB_DRAWABLE, "box-left-drawable",     "<Box face> left" },
    { GIMP_PDB_DRAWABLE, "box-right-drawable",    "<Box face> right" },
    { GIMP_PDB_DRAWABLE, "cyl-top-drawable",      "<Cylinder face> top (set these to -1 if not used)" },
    { GIMP_PDB_DRAWABLE, "cyl-bottom-drawable",   "<Cylinder face> bottom" }
  };
